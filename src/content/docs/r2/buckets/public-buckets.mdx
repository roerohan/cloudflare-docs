...
There is a restriction when using custom domains to access R2 buckets. The domain being used must have been added as a zone in the same account as the R2 bucket.
