...
export default function SubtractIPCalculator({
	...
	return (
		<div className="rounded-md border border-solid border-gray-200 p-6 no-underline dark:border-gray-700">
			...
			<div>
				<button
					className="bg-cl1-brand-orange text-cl1-black disabled:bg-cl1-gray-4 disabled:text-cl1-gray-1 h-8 cursor-pointer rounded border-0 px-4 text-sm font-medium disabled:cursor-not-allowed"
